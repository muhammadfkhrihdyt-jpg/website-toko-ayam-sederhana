...
VALUES
  ...
  ('Kulit', 'kulit', 'Kulit ayam pilihan untuk menu goreng dan olahan.', '/brand/chicken-products.jpg', 'Specific Part', 38500.00, 50, 1000, 1, 1, NOW(), NOW()),
  ('Ceker', 'ceker', 'Ceker ayam segar untuk sup dan olahan.', '/brand/chicken-products.jpg', 'Specific Part', 27000.00, 50, 1000, 1, 1, NOW(), NOW()),
